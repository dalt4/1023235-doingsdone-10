...
INSERT INTO tasks (name, done_date, categories_id, status, user_id)
VALUES ('Собеседование в IT компании', '2019.12.01', 3, 0, 1),
...
VALUES ('mr first', 'first@mail.mail', 'p'),
...
UPDATE tasks
SET name = 'Сделать задание четвертого раздела'
WHERE id = 3;
